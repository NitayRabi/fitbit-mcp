...
const accessToken = argv["fitbit-token"] || process.env.FITBIT_ACCESS_TOKEN;
const baseUrl = "https://api.fitbit.com/1";

// Validate access token
if (!accessToken) {
  console.error(
    "Error: Fitbit access token is required. Provide it with --fitbit-token or FITBIT_TOKEN environment variable."
  );
  process.exit(1);
}
...
// Register tool for getting location data
